                                    ...
                                    <div class="pt-4 border-t border-blue-200">
                                        ...
                                        <?php if (isset($common['tryNowUrl']) && $common['tryNowUrl']): ?>
                                            <a href="<?php echo $common['tryNowUrl']; ?>" 
                                               ...
                                               class="flex items-center justify-center w-48 h-14 bg-black hover:bg-gray-800 text-white rounded-lg hover:scale-105 hover:-translate-y-1 transition-all duration-300 transform shadow-lg hover:shadow-2xl group">
